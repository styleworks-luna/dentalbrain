            ...
            <li v-for="lecture in lectures" :key="lecture.id">
                <div class="content-information-wrap">
                    ...
                    <div class="content-information">
                        <div class="lecture-sort">
                            ...
                            <p class="lecture-date" v-if="lecture.program.minor_category_name!='스토어'">수강기간 {{ lecture.program.term }}일</p>
                        </div>
                ...
                <div class="lecture-under">
                    <div class="lecture-sub-information">
                        ...
                        <template v-else>
                            <!-- 온라인 -->
                            <div class="content-time" v-if="lecture.program.is_online">
                                <p>시청 가능 기간</p>
                                <!-- 남은 기간 많을 때 -->
                            ...
                            <div class="offline-lecture-pay" v-else>
                                ...
                                <div class="d-day"><em>
                                    {{
                                        lecture.program.price == 0 ? '무료' : Helper.numberWithCommas(lecture.program.price) + '원'
                                    }}
                                </em></div>
                            </div>
                        </template>
