                    ...
                    <div class="lecture-under">
                        <div class="btn-zone">
                            <template v-if="lecture.programs_qualification_id != null">
                                <template v-if="lecture.qualification_status == 2"><p>자격증 대기중</p></template>
                            ...
                            <template v-if="lecture.programs_completion_id  != null">
                                <template v-if="lecture.completion_status == 2"><p class="btn-lecture fail">수료증 대기중</p></template>
