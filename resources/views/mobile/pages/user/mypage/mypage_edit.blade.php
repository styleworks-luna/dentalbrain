            ...
            <form action="{{ route('account.update') }}" id="edit-form" method="POST">
                ...
                <section class="edit">
                    <div class="m-row">
                        <ul>
                            <li>
                                <div class="input-head"><h3>이름</h3></div>
                                <p class="name">{{ auth()->user()->name }}</p>
                            </li>
                            <li>
                                <div class="input-head"><h3>아이디</h3></div>
                                <p class="login-id">{{ auth()->user()->login_id }}</p>
                            </li>
                            <li>
                                <div class="input-head"><label for="email">이메일</label></div>
                            ...
                            <li>
                                <div class="input-head"><label for="phone">휴대전화</label></div>
                                <div class="input-wrap">
                                    <div class="phone-wrap">
                                        ...
                                        <button type="button" id="send_authentication"
                                                class="btn-basic btn-verification">
                                            인증번호발송
                                        </button>
                            ...
                            <li>
                                <div class="input-head"><label for="upw">비밀번호 변경</label></div>
                                <div class="input-wrap">
