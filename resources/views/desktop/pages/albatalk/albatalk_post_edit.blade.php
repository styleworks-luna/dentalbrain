                                        ...
                                        <div class="radio-container">
                                            ...
                                            <div class="radio-wrap">
                                                <input type="radio" id="career_field_02" class="career" name="is_career"
                                                       ...
                                                       @if(old('is_career', $recruit->typeCareer->id ==
                                                                            \App\Models\Recruit\Option\TypeCareer::TYPE_CAREER_2 ||
                                                                            $recruit->typeCareer->id ==
                                                                            \App\Models\Recruit\Option\TypeCareer::TYPE_CAREER_3 ||
                                                                            $recruit->typeCareer->id ==
                                                                            \App\Models\Recruit\Option\TypeCareer::TYPE_CAREER_4 ||
                                                                            $recruit->typeCareer->id ==
                                                                            \App\Models\Recruit\Option\TypeCareer::TYPE_CAREER_5 ) == \App\Models\Recruit\Recruit::SENIOR) checked @endif>
                                                ...
                                                <select name="career" id="career"
                                                        ...
                                                        @if(old('is_career', $recruit->typeCareer->id ==
                                                                            ...
                                                                            \App\Models\Recruit\Option\TypeCareer::TYPE_CAREER_4 ||
                                                                            $recruit->typeCareer->id ==
                                                                            \App\Models\Recruit\Option\TypeCareer::TYPE_CAREER_5 ) != \App\Models\Recruit\Recruit::SENIOR) disabled @endif>
                                                    ...
                                                    @foreach($typeCareer as $career)
                                                        @if($career->id ==
                                                            ...
                                                            <option value="{{ $career->id }}"
                                                                @if(old('$career', $recruit->typeCareer->id) == $career->id) selected @endif>{{ $career->type }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            @foreach($typeDay as $day)
                                                <div class="radio-wrap">
                                                    <input type="radio"
                                                           ...
                                                           class="work-day"
                                                           value={{$day->id}}
                                                           @if(old('day', $recruitDays[0]->type_day_id) == $day->id) checked
                                                           @endif
                                                           data-parsley-required="true"
