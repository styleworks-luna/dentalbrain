                            ...
                            <tr>
                                <td>
                                    <input type="text"
                                           ...
                                           value="{{ old('career_started_at_1', $resume->career_started_at_1) }}">
                                    <span>~</span>
                                    <input type="text"
                                           id="first_career_term_start"
                                           class="term"
                                           name="career_ended_at_1"
                                           value="{{ old('career_ended_at_1', $resume->career_ended_at_1) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="first_certificate_day"
                                           name="career_company_1"
                                           value="{{ old('career_company_1', $resume->career_company_1) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="first_certificate_agency"
                                           name="career_task_1"
                                           value="{{ old('career_task_1', $resume->career_task_1) }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="text"
                                           ...
                                           value="{{ old('career_started_at_2', $resume->career_started_at_2) }}">
                                    <span>~</span>
                                    <input type="text"
                                           id="second_career_term"
                                           class="term"
                                           name="career_ended_at_2"
                                           value="{{ old('career_ended_at_2', $resume->career_ended_at_2) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="second_certificate_day"
                                           name="career_company_2"
                                           value="{{ old('career_company_2', $resume->career_company_2) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="second_certificate_agency"
                                           name="career_task_2"
                                           value="{{ old('career_task_2', $resume->career_task_2) }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="text"
                                           ...
                                           value="{{ old('career_started_at_3', $resume->career_started_at_3) }}">
                                    <span>~</span>
                                    <input type="text"
                                           id="second_certificate_agency"
                                           class="term"
                                           name="career_ended_at_3"
                                           value="{{ old('career_ended_at_3', $resume->career_ended_at_3) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="third_certificate_day"
                                           name="career_company_3"
                                           value="{{ old('career_company_3', $resume->career_company_3) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="third_certificate_agency"
                                           name="career_task_3"
                                           value="{{ old('career_task_3', $resume->career_task_3) }}">
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="text"
                                           ...
                                           value="{{ old('career_started_at_4', $resume->career_started_at_4) }}">
                                    <span>~</span>
                                    <input type="text"
                                           id="second_career_term"
                                           class="term"
                                           name="career_ended_at_4"
                                           value="{{ old('career_ended_at_4', $resume->career_ended_at_4) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="fourth_certificate_day"
                                           name="career_company_4"
                                           value="{{ old('career_company_4', $resume->career_company_4) }}">
                                </td>
                                <td>
                                    <input type="text"
                                           id="fourth_certificate_agency"
                                           name="career_task_4"
                                           value="{{ old('career_task_4', $resume->career_task_4) }}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
