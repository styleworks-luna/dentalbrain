            ...
            <section class="payment-history">
                ...
                <ul>
                    @forelse($payments as $payment)
                        ...
                        @isset ($payment->student)
                            <li>
                                <div class="lecture-information">
                                    <span
                                        class="lecture-type">{{ $payment->student->program->minor_category_name }}</span>
                        ...
                        @endisset
                        @isset($payment->recruit)
                            <li>
                                <div class="lecture-information">
                                    <h3 class="lecture-name">{{ $payment->recruit->company_name }}</h3>
                                </div>
                                <table class="payment-information">
                                    <tr>
                                        <th>결제금액</th>
                                    ...
                                    <tr>
                                        ...
                                        @switch($payment->status)
                                            ...
                                            <td>확인 중</td>
                                        @endswitch
                                        <td>{{ changePaymentMethodName($payment->method) }}
                                            @if($payment->method == '가상계좌' && $payment->status =='WAITING_FOR_DEPOSIT')
                                                <a href="" class="waiting-deposit">자세히 보기</a>
                                                <div class="deposit-detail">
                                                    <p>입금 계좌 : {{ $payment->va_accountNumber }}</p>
