...
class CreateQualificationProfilesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('qualification_profiles', function (Blueprint $table) {
            ...
            $table->bigInteger('certificate_number')->nullable()->comment('자격번호');
